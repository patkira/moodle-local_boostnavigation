...
$string['setting_removebadgenode'] = 'Remove "Badge" node';
$string['setting_removebadgenode_desc'] = 'Enabling this setting will remove the "Badge" node from Boost\'s nav drawer if there are no badges in the course';
$string['setting_removecompetencynode'] = 'Remove "Competency" node';
$string['setting_removecompetencynode_desc'] = 'Enabling this setting will remove the "Competency" node from Boost\'s nav drawer if there are no competencies in the course. If you do this, please enable the "Competency" node in the course settings';
$string['setting_addcompetencynode'] = 'Add "Competency" node in the complete course settings page';
$string['setting_addcompetencynode_desc'] = 'Enabling this setting will add the "Competency" node to the complete course settings. Don\'t forget to enable this if you removed competency from nav drawer.';
